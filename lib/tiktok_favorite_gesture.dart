...
class TiktokFavoriteGesture extends StatefulWidget {
  ...
  @override
  _TiktokFavoriteGestureState createState() => _TiktokFavoriteGestureState();
}

class _TiktokFavoriteGestureState extends State<TiktokFavoriteGesture> {
